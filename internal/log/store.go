...
// A store struct is a wrapper around a file
// with APIs to append and read bytes to and from the file
type store struct {
	*os.File
	mu   sync.Mutex
	buf  *bufio.Writer
...
// ReadAt reads len(p) bytes into p, beginning at the given offset
