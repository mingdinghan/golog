...
// newSegment adds a new segment, such as when the current active segment hits its max size
...
// Read return the record for the given offset
...
// nearestMultiple returns the largest multiple of k smaller than j
