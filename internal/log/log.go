...
// setup the segments that already exist on disk or bootstrap the initial segment
...
// newSegment creates a new segment, appends it to the log's slice of segments, and makes it the active segment
