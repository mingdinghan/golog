...
// NewGRPCServer instantiates the gRPC service, creates a gRPC server, and registers the service to that server
func NewGRPCServer(config *Config, opts ...grpc.ServerOption) (*grpc.Server, error) {
	// differentiate server logs from other logs. Log each request's duration in nanoseconds
...
// subject returns the client's cert's subject in order to identify a client and check their access
