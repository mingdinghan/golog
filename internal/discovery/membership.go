...
// Membership is a type that wraps Serf to provide discovery and cluster membership
...
// eventHandler loops through events in channel and handles each incoming event according to type
...
// logError logs all handler errors at the critical level, but non-leader errors only at the debug level.
